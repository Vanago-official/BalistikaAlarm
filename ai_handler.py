...
2. Якщо 'СТАТУС ЗАГРОЗИ МІСТУ' = АКТИВНА, і нове повідомлення (наприклад, "ще цілі", "повернула на нас") логічно продовжує загрозу для {CITY} — відповідай THREAT.
3. Якщо 'СТАТУС ЗАГРОЗИ МІСТУ' = НЕМАЄ, реагуй (THREAT) ЛИШЕ коли в новому повідомленні чітко згадується {CITY} або очевидна загальна балістична загроза (наприклад, "Балістика!", "Пуски!").
4. Якщо повідомлення вказує на закінчення загрози ("чисто", "дорозвідка", "відбій", "зникла", "впала") — відповідай CLEAR.
